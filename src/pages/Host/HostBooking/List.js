...
import { getAllBookingOnlines, updateStatus, getBookingOnline } from '~/services/hostbookingonline.service';
                                                    ...
                                                    (bookingOnline, index) =>
                                                        ...
                                                        index < maxIndex && (
                                                            <tr key={bookingOnline.id}>
                                                                ...
                                                                <td>
                                                                    {bookingOnline.status.id !== 3 &&
                                                                    bookingOnline.status.id !== 4 ? (
                                                                        <>
                                                                            <Form.Control
                                                                                as="select"
